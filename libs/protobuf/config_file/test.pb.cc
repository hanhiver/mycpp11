...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_test_2eproto = {
  false, false, descriptor_table_protodef_test_2eproto, "test.proto", 300,
...
ProtoTestSub::ProtoTestSub(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:msgType.ProtoTestSub)
}
ProtoTestSub::ProtoTestSub(const ProtoTestSub& from)
  ...
  if (!from._internal_test2().empty()) {
    test2_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_test2(),
      GetArena());
  }
  test1_ = from.test1_;
...
void ProtoTestSub::ArenaDtor(void* object) {
  ProtoTestSub* _this = reinterpret_cast< ProtoTestSub* >(object);
  (void)_this;
}
void ProtoTestSub::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:msgType.ProtoTestSub)
  ...
  if (from.test2().size() > 0) {
    _internal_set_test2(from._internal_test2());
  }
  if (from.test1() != 0) {
...
void ProtoTestSub::InternalSwap(ProtoTestSub* other) {
  ...
  test2_.Swap(&other->test2_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
...
ProtoTest::ProtoTest(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:msgType.ProtoTest)
}
ProtoTest::ProtoTest(const ProtoTest& from)
  ...
  if (!from._internal_str_test().empty()) {
    str_test_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_str_test(),
      GetArena());
  }
  ...
  if (!from._internal_bytes_test().empty()) {
    bytes_test_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_bytes_test(),
      GetArena());
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:msgType.ProtoTest)
  ...
  if (from.str_test().size() > 0) {
    _internal_set_str_test(from._internal_str_test());
  }
  if (from.bytes_test().size() > 0) {
    _internal_set_bytes_test(from._internal_bytes_test());
  }
...
void ProtoTest::InternalSwap(ProtoTest* other) {
  ...
  str_test_.Swap(&other->str_test_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  bytes_test_.Swap(&other->bytes_test_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ProtoTest, enum_test_)
      + sizeof(ProtoTest::enum_test_)
      - PROTOBUF_FIELD_OFFSET(ProtoTest, int32_test_)>(
          reinterpret_cast<char*>(&int32_test_),
          reinterpret_cast<char*>(&other->int32_test_));
}
...
template<> PROTOBUF_NOINLINE ::msgType::ProtoTestSub* Arena::CreateMaybeMessage< ::msgType::ProtoTestSub >(Arena* arena) {
  return Arena::CreateMessageInternal< ::msgType::ProtoTestSub >(arena);
}
template<> PROTOBUF_NOINLINE ::msgType::ProtoTest* Arena::CreateMaybeMessage< ::msgType::ProtoTest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::msgType::ProtoTest >(arena);
}
