# Known NVIDIA GPU achitectures Infer can be compiled for.
# This list will be used for CUDA_ARCH_NAME = All option
set(Infer_known_gpu_archs "30 35 50 52 60 61 70")

################################################################################################
# A function for automatic detection of GPUs installed  (if autodetection is enabled)
# Usage:
#   infer_detect_installed_gpus(out_variable)
function(infer_detect_installed_gpus out_variable)
  if(NOT CUDA_gpu_detect_output)
    ...
    if(__nvcc_res EQUAL 0)
      set(CUDA_gpu_detect_output ${__nvcc_out} CACHE INTERNAL "Returned GPU architectures from infer_detect_gpus tool" FORCE)
    endif()
  endif()

  if(NOT CUDA_gpu_detect_output)
    message(STATUS "Automatic GPU detection failed. Building for all known architectures.")
    set(${out_variable} ${Infer_known_gpu_archs} PARENT_SCOPE)
  else()
...
# Usage:
#   infer_select_nvcc_arch_flags(out_variable)
function(infer_select_nvcc_arch_flags out_variable)
  # List of arch names
  ...
  if(${CUDA_ARCH_NAME} STREQUAL "Manual")
    set(CUDA_ARCH_BIN ${Infer_known_gpu_archs} CACHE STRING "Specify 'real' GPU architectures to build binaries for, BIN(PTX) format is supported")
  ...
  elseif(${CUDA_ARCH_NAME} STREQUAL "All")
    set(__cuda_arch_bin ${Infer_known_gpu_archs})
  elseif(${CUDA_ARCH_NAME} STREQUAL "Auto")
    infer_detect_installed_gpus(__cuda_arch_bin)
  ...
  infer_list_unique(__cuda_arch_bin __cuda_arch_ptx)

  set(__nvcc_flags "--expt-extended-lambda --use_fast_math ")
...
# Usage:
#   infer_cuda_compile(<objlist_variable> <cuda_files>)
macro(infer_cuda_compile objlist_variable)
...
find_cuda_helper_libs(nvcuvid) #for decoder
...
list(APPEND Infer_LINKER_LIBS ${CUDA_CUDART_LIBRARY} ${CUDA_CUDA_LIBRARY}  ${CUDA_nvcuvid_LIBRARY}
                              ${CUDA_curand_LIBRARY} ${CUDA_CUBLAS_LIBRARIES} ${CUDA_npp_LIBRARY})
...
#  ENDIF()
  ...
  if(HAVE_CUDNN)
    ...
    list(APPEND Infer_LINKER_LIBS ${CUDNN_LIBRARY})
  endif()
endif()
...
infer_select_nvcc_arch_flags(NVCC_FLAGS_EXTRA)
...
if(APPLE)
  infer_detect_darwin_version(OSX_VERSION)
  ...
  if(OSX_VERSION VERSION_GREATER 10.8)
    ...
    infer_option(USE_libstdcpp "Use libstdc++ instead of libc++" (CUDA_VERSION VERSION_LESS 7.0))
  endif()
endif()
