...
std::string COpenSSL::aes_encrypt(const std::string &clearText, const std::string &key)
{
    // encripted string.
	std::string cipherText;
...
std::string COpenSSL::aes_decrypt(const std::string &cipherText, const std::string &key)
{
    // clear text. 
	std::string clearText; 
